...
public final class ActivityTtwinnerScreenBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityTtwinnerScreenBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ActivityTtwinnerScreenBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityTtwinnerScreenBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_ttwinner_screen, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityTtwinnerScreenBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityTtwinnerScreenBinding((ConstraintLayout) rootView, constraintLayout4,
