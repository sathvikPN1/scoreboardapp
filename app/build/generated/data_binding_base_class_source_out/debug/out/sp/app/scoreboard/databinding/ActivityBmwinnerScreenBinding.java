...
public final class ActivityBmwinnerScreenBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityBmwinnerScreenBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ActivityBmwinnerScreenBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityBmwinnerScreenBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_bmwinner_screen, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityBmwinnerScreenBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityBmwinnerScreenBinding((ConstraintLayout) rootView, constraintLayout4,
